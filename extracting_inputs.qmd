...
```{r child="wheeler-lab/abcd/prashanth-proj/03-get-inputs/get_acute_symptoms.Rmd", eval=TRUE}
...
The analyses in this report are only concerned with white matter structures, which are present in the following ROIs:
...
```{r child="wheeler-lab/abcd/prashanth-proj/03-get-inputs/get_brain_str.Rmd", eval=TRUE}
...
```{r child="wheeler-lab/abcd/prashanth-proj/03-get-inputs/get_demographics.Rmd", eval=TRUE}
