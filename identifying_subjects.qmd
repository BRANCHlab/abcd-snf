...
## Assigning meaningful mTBI variables

The provided variable names are non-descriptive.
A renamed version of the data is used for all subsequent analyses.
The code below was used for renaming the abcd_otbi01.txt file.

```{r child="wheeler-lab/abcd/prashanth_proj/rename-data/rename_abcd_otbi01.Rmd"}
```
...
```{r child="wheeler-lab/abcd/prashanth_proj/process-data/generate_abcd_otbi01_detailed.Rmd"}
```
...
```{r child="wheeler-lab/abcd/prashanth_proj/get-subjects/get_baseline_mtbi_subjects.Rmd"}
```
